...
fun rangeOf(number: Int) {
    ...
    if (number in 1..5) {
        println("Number  1 falls between 1 and 5")
    }

    if (number in 6..10)
        println("Number 6 falls between 6 and 10")

    if (number in 11..20)
        println("Number 11 falls between 6 and 10")
}
...
fun inferredTypeOf(variable: Any){
    ...
    val number = 5
    if(number is Int) {
        println("number is of type Int") //https://stackoverflow.com/questions/44732706/how-do-i-know-inferred-type-in-kotlin
...
fun stringContains(str : String){
    ...
    val aString = "It contains A!\n"
    print(aString)

    val bString = "It contains b!\n"
    print(bString)

    val cString = "It contains c!\n"
    print(cString)

    val String = "It is empty\n"
    print(String)
